...
`REPO_URL` is preconfigured as `https://github.com/EngIaCeub/Machine_Learning_Inadimplencia.git`. The Colab publication URL is `https://colab.research.google.com/github/EngIaCeub/Machine_Learning_Inadimplencia/blob/main/notebooks/FINAL_COLAB_REPRODUCIBLE.ipynb`. No manual upload, personal Drive, Windows path, credential, or GPU is required.
